...
const dailyNotePath = `2. Area/Daily Plan/${tYear}/${tMonthMM}`;
...
var cellTemplate = `<div class='cell {{class}}' data-weekday='{{weekday}}'><a class='internal-link cellName' href='${dailyNotePath}/{{dailyNote}}'>{{cellName}}</a><div class='cellContent'>{{cellContent}}</div></div>`;
